                    ...
                    <div class="card">
                        ...
                        https://laravel.com/docs/9.x/session#determining-if-an-item-exists-in-the-session --}}
                            ...
                            <form class="forms-sample"
                                @if (empty($category['id'])) action="{{ url('admin/add-edit-category') }}" @else
                            action="{{ url('admin/add-edit-category/' . $category['id']) }}" @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="category_name"
                                        ...
                                        @if (!empty($category['category_name'])) value="{{ $category['category_name'] }}" @else
                                ...
                                <div id="appendCategoriesLevel"> {{-- We create this <div> in a separate file in order for
                                    the appendCategoryLevel() method inside the CategoryController to be able to return
                                    the whole file as a response to the AJAX call in admin/js/custom.js to show the
                                    proper/relevant categories <select> box <option> depending on the chosen Section
                                            --}}
                                ...
                                <div class="form-group">
                                    ...
                                    @if (!empty($category['category_image']))
                                        ...
                                        {{-- Delete the
                                    category image from BOTH SERVER (FILESYSTEM) & DATABASE --}} {{-- Check
                                    admin/js/custom.js and web.php (routes) --}}
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="category_discount"
                                        ...
                                        @if (!empty($category['category_discount'])) value="{{ $category['category_discount'] }}" @else
                                        value="{{ old('category_discount') }}" @endif>
                                </div>
                                <div class="form-group">
                                    <label for="description">Category Description</label>
                                    {{-- <input type="text" class="form-control" id="category_discount"
                                        placeholder="Enter Category Description" name="category_discount" @if (!empty($category['category_discount']))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="meta_description"
                                        ...
                                        @if (!empty($category['meta_description'])) value="{{ $category['meta_description'] }}" @else
