                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" @if (empty($brand['id'])) action="{{ url('admin/add-edit-brand') }}"
                            @else action="{{ url('admin/add-edit-brand/' . $brand['id']) }}" @endif method="post"
                            enctype="multipart/form-data">
                            <!-- If the id is not passed in from the route, this measn 'Add a new Brand', but if the id is passed in from the route, this means 'Edit the Brand' -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="brand_name" placeholder="Enter Brand Name"
                                    name="brand_name" @if (!empty($brand['name'])) value="{{ $brand['name'] }}" @else
