                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample"
                            ...
                            <!-- If the id is not passed in from the route, this measn 'Add a new Shipping Charge', but if the id is passed in from the route, this means 'Edit the Shipping Charge' -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="0_500g" placeholder="Enter Shipping Rate"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="501g_1000g"
                                    placeholder="Enter Shipping Rate" name="501g_1000g"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="1001_2000g"
                                    placeholder="Enter Shipping Rate" name="1001_2000g"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="2001g_5000g"
                                    placeholder="Enter Shipping Rate" name="2001g_5000g"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="above_5000g"
                                    placeholder="Enter Shipping Rate" name="above_5000g"
