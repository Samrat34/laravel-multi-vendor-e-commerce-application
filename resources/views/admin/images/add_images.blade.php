                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ url('admin/add-images/' . $product['id']) }}"
                            method="post" enctype="multipart/form-data"> {{-- "enctype" attribute must be used becasue
                            ...
                            <div class="form-group">
                                ...
                                @else
                                <img style="width: 120px"
                                    src="{{ url('front/images/product_images/small/no-image.png') }}"> {{-- the 'small'
                                image --}}
                                @endif
                            </div>
                            ...
                            <div class="form-group">
                                <div class="field_wrapper">
                                    <input type="file" name="images[]" multiple id="images"> {{-- Upload multiple images
                                    for the product --}} {{-- "multiple" HTML attribute:
                                ...
                                @foreach ($product['images'] as $image) {{-- using the relationship 'images' --}}<tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="updateImageStatus" id="image-{{ $image['id'] }}"
                                            image_id="{{ $image['id'] }}" href="javascript:void(0)"> {{-- Using HTML
                                            Custom Attributes. Check admin/js/custom.js --}}
                                        ...
                                        <a href="JavaScript:void(0)" class="confirmDelete" module="image"
                                            moduleid="{{ $image['id'] }}"> {{-- Check admin/js/custom.js and web.php
                                            (routes) --}}
                                            <i style="font-size: 25px" class="mdi mdi-file-excel-box"></i> {{-- Icons
                                            from Skydash Admin Panel Template --}}
                                        </a>
                                    </td>
                                </tr>
                                @endforeach
