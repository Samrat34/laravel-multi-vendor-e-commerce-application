                    ...
                    <div class="card-body">
                                ...
                                <div class="field_wrapper">
                                    <div>
                                        <input type="text" name="size[]" placeholder="Size" style="width:100px"
                                            required> {{-- !! Note that the "name" HTML attribute is an ARRAY (using
                                        SQUARE BRAKETS [] !!) --}}
                                        <input type="text" name="sku[]" placeholder="SKU" style="width:100px" required>
                                        {{-- !! Note that the "name" HTML attribute is an ARRAY (using SQUARE BRAKETS []
                                        !!) --}}
                                        ...
                                        {{-- Add another 4 input fields like the former --}}
                                    </div>
                                </div>
                            </div>
                        ...
                        <form method="post" action="{{ url('admin/edit-attributes/' . $product['id']) }}">
                            ...
                            <table id="products" class="table table-bordered"> {{-- using the id here for the DataTable
                                ...
                                <tbody>
                                    @foreach ($product['attributes'] as $attribute) {{-- using the relationship
                                    'attributes' --}}
                                    {{-- <input type="hidden" name="attributeId[]" value="{{ $attribute['id'] }}"> --}}
                                    {{-- A hidden input field --}} {{-- IMPORTANT NOTE: DIDN'T WORK INSIDE FOR LOOP!!
                                    MUST BE OUSTSIDE IT IN ORDER TO WORK! --}}
                                    <input style="display: none" type="text" name="attributeId[]"
                                        value="{{ $attribute['id'] }}"> {{-- A hidden input field --}}
                                    <tr>
                                        <td>{{ $attribute['id'] }}</td>
                                        ...
                                        <td>
                                            <input type="number" name="price[]" value="{{ $attribute['price'] }}"
                                                required style="width: 60px"> {{-- !! Note the "name" HTML attribute
                                            SQUARE BRACKETS [] !! --}}
                                        </td>
                                        <td>
